...
class ProjectGrpcServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddProject = channel.unary_unary(
                '/project.ProjectGrpcService/AddProject',
...
def add_ProjectGrpcServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'project.ProjectGrpcService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('project.ProjectGrpcService', rpc_method_handlers)
